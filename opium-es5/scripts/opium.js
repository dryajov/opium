...
var Opium = (function () {
    ...
    _createClass(Opium, [{
        ...
        key: 'register',
        value: function register(name, dep, deps, injector, lifecycle) {
            this.registry.set(name, new _dependency2['default'](name, dep, deps, this.registry, injector, lifecycle));
        }
...
//# sourceMappingURL=../scripts/opium.js.map